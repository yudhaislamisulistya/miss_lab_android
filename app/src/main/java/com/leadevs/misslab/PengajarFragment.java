...
public class PengajarFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root = inflater.inflate(R.layout.fragment_pengajar, container, false);
    ...
    private void setUpViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new PengajarDosenFragment(), "Dosen");
        adapter.addFragment(new PengajarAsistenFragment(), "Asisten");

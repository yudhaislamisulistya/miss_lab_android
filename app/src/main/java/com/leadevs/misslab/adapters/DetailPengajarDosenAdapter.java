...
public class DetailPengajarDosenAdapter extends RecyclerView.Adapter<DetailPengajarDosenAdapter.MyViewHolder> {
    ...
    public DetailPengajarDosenAdapter(Context context, List<DetailPengajar> mData, OnDetailPengajarListener onDetailPengajarListener) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_detail_pengajar_dosen_detail_absensi,viewGroup,false);
